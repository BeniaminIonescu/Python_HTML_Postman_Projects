...
try:
    country, salesRepEmployeeNumber, creditLimit) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", (custList[y][1], custList[y+1][1], custList[y+2][1], custList[y+3][1], custList[y+4][1], custList[y+5][1], custList[y+6][1], custList[y+7][1], custList[y+8][1], custList[y+9][1], custList[y+10][1], custList[y+11][1], custList[y+12][1]))
